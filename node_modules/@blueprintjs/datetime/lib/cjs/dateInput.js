...
var DateInput = /** @class */ (function (_super) {
    ...
    DateInput.prototype.render = function () {
        ...
        return (React.createElement(core_1.Popover, tslib_1.__assign({ isOpen: this.state.isOpen && !this.props.disabled, usePortal: false }, popoverProps, { autoFocus: false, className: classnames_1.default(popoverProps.className, this.props.className), content: wrappedPopoverContent, enforceFocus: false, onClose: this.handleClosePopover, popoverClassName: classnames_1.default(Classes.DATEINPUT_POPOVER, popoverProps.popoverClassName) }),
