...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    DateRangePicker.prototype.render = function () {
        ...
        if (contiguousCalendarMonths || isShowingOneMonth) {
            var classes = classnames_1.default(DateClasses.DATEPICKER, DateClasses.DATERANGEPICKER, className, (_c = {},
            ...
            return (React.createElement("div", { className: classnames_1.default(DateClasses.DATEPICKER, DateClasses.DATERANGEPICKER, className) },
                this.maybeRenderShortcuts(),
